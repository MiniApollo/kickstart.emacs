...
- [[https://www.emacswiki.org/emacs/UndoTree][UndoTree]] :: Visualizes the undo history with more emacs native features (alternative [[https://github.com/casouri/vundo][Vundo]] with [[https://github.com/emacsmirror/undo-fu-session][undo-fu-session]]).
