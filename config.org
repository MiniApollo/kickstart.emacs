...
It is *recommended* to configure it from the *config.org* file.
...
** Package manager
We use the default package manager package.el.
...
- Messages buffer fix in general keybindings section  (:ghook)
- And also change general.el keybindings
# #+begin_src emacs-lisp
#     (use-package evil
#       :init
#       (evil-mode)
...
TODO: Rewrite this to use use-package :general keyword
#+begin_src emacs-lisp
    (use-package general
      :config
      ...
      (general-create-definer start/leader-keys
        ...
        :keymaps 'override
        ;;:prefix "SPC"           ;; Set leader key <- evil
        :prefix "C-SPC"           ;; For default emacs keybindigs
