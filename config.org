...
- [[#important-to-load-first][Important to load first]]
  ...
  - [[#copy-environmental-variables][Copy environmental variables]]
  - [[#evil-mode][Evil Mode]]
...
#+end_src
*** Org download
Download images to org document using drag and drop from internet.
#+begin_src emacs-lisp
...
:ensure t
:config 
(yank-media-register-handler 'org-mode)
)
