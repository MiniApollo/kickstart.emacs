...
We merge capfs together so they apper together in the completion list.
The ones not merged will display seperately (Only their list will show up in the completion list).
